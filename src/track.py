...
def main(seed, dataset_name, obj_detect_checkpoint_file, tracker_cfg,
    ...
    if obj_detector_model is None:
        ...
        print("obj_detector:", obj_detector)
        print("obj_detector_post", obj_detector_post)
        sys.exit(0)
...
if __name__ == '__main__':
    main(dataset_name='DEMO',data_root_dir='data/snakeboard',output_dir='data/snakeboard',write_images='pretty')
